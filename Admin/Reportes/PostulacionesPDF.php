...
function Header()
{
    ...
    $this->Cell(60);
    // Título
	$this->Cell(215,65,utf8_decode('Postulaciones Activas'),0,0,'C');
    // Salto de línea
    $this->Ln(42);
...
$pdf->Cell(53,10, utf8_decode("Cédula estudiante"), 1, 0, 'C', 0);
$pdf->Cell(53,10, utf8_decode("Carrera"), 1, 0, 'C', 0);
$pdf->Cell(53,10, utf8_decode("Titulo promoción"), 1, 0, 'C', 0);
...
foreach ($lista as $sql2) {
    ...
    $pdf->Output('D','Postulaciones.pdf',false);
?>