...
<div class="row no-gutters">
  ...
  <div class="col-md-6 mb-3">
    <div class="input-group">
      ...
      <input autocomplete="off"  type="text" class="form-control" placeholder="Apellidos " aria-label="Username">
    </div>
  </div>
</div>
<div class="row no-gutters">
  ...
  <div class="col-md-6 mb-3">
    <div class="input-group">
      ...
      <input  type="text"  autocomplete="off" class="form-control" placeholder="Teléfono " aria-label="Username">
    </div>
  </div>
</div>
...
<div class="row no-gutters">
  <div class="col-md-6 mb-3">
    <div class="input-group">
      ...
      <input  autocomplete="off" type="password" class="form-control" placeholder="Contraseña"  style="display:none;" aria-label="Username">
      <input  autocomplete="off" type="password" class="form-control" placeholder="Contraseña" aria-label="Username">
    </div>
  </div>
  <div class="col-md-6 mb-3">
    <div class="input-group">
      ...
      <input  autocomplete="off" type="password" class="form-control" placeholder="Validar Contraseña " aria-label="Username">
    </div>
  </div>
</div>
