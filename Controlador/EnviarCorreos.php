    ...
    public function enviarMensaje($nombre,$para,$asunto,$mensaje){
        try {
            ...
            ***********************************************/
            ...
            <table name="bmeMainContent" style="border-radius: 0px; border-collapse: separate; border-spacing: 0px; border: 0px none transparent;" width="100%" cellspacing="0" cellpadding="0" border="0" align="center"><tbody><tr><td width="100%" class="blk_container bmeHolder" name="bmeHeader" valign="top" align="center" style="color: rgb(56, 56, 56); border: 0px none transparent; background-color:#84ae40" bgcolor="#00ae54"><div id="dv_1" class="blk_wrapper" style="">    
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0"><tbody><tr><td align="center" class="bmeImage" style="border-collapse: collapse; padding: 20px;"><img    
                src="./assets/images/Universidad.png" class=img-responsive page-base-image" width="100" style="max-width: 1200px; display: block; width: 100px;" alt="" border="0">
                <img  alt="PHPMailer" src="cid:my-photo"></td></tr></tbody>    
            </table></td></tr></tbody>    
            ...
            <br><span style="font-size: 14px; font-family: "Arial", Courier; color: #464646; line-height: 150%;">La Feria Laboral te quiere comunicar algo.</span></div></td></tr></tbody>    
            </table></td></tr></tbody>    
            </table></td></tr></tbody>    
            ...
            <table width="600" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_text"><tbody><tr><td>    
            <table cellpadding="0" cellspacing="0" border="0" width="100%" class="bmeContainerRow"><tbody><tr><td class="tdPart" valign="top" align="center" style="background-color:#84ae40;">    
            <table cellspacing="0" cellpadding="0" border="0" width="600" name="tblText" style="float: left; background-color:#84ae40;" align="left" class="tblText"><tbody><tr><td valign="top" align="left" name="tblCell" style="padding: 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell"><div style="line-height: 150%; text-align: center;"><span style="font-size: 20px; font-family: "Arial", Courier; color: #ffffff; line-height: 150%;"><center>Universidad El Bosque</center></span>    
            ...
            <a href="https://www.facebook.com/universidadelbosque/" target=_blank  style="display: inline-block;background-color: #84ae40 ;border-radius: 0px;border-style: none; border-width: 0px; border-color: rgba(0, 0, 0, 0);" target="_blank"><img    
            ...
            <a href="https://twitter.com/UElBosque" target=_blank  style="display: inline-block;background-color: #84ae40;border-radius: 0px;border-style: none; border-width: 0px; border-color: rgba(0, 0, 0, 0);" target="_blank"><img    
