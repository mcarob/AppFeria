...
<body style="background-image: url(assets/img/fondoInicio.png); background-repeat: no-repeat; display: block; margin-left: auto; margin-right: auto; width: 100%; background-size: cover;">
