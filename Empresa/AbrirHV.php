...
if(isset($_GET['idHoja'])){

    $esdao= new estudianteDAO();
    $controlHoja= new ControladorHojaDeVida();
    $codigoEst=$esdao->devolverEstudianteEmpresa($_GET['idHoja']);
...
<div id="contendp">
    ...
    <div id="informacion">
        ...
        <div id="datos">
            ...
            <table width="100%">
                ...
                <tr>
                    <td width="50%"><b>Correo Electrónico</b></td>
    ...
    <div id="firma">
        <div id="datos8"> <br><b>'.
        $codigoEst->getNombreEstudiante() ." ".$codigoEst->getApellidoEstudiante().'
       <p style="line-height:1px;margin:0px;"> <br><b>_______________________________________________</b> </p>
            <p><b>C.C: '.$codigoEst->getCedEstudiante().'</b></p>
            <p><b>Fecha de actualización: '.date("d/m/Y") .'</b></p>
        </div>
