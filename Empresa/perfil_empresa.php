                            ...
                            <div class="mt-5">
                                <form action="javascript: EditarPerfil();" method="POST" id="formEditar">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="nombres" value="<?php echo($administrador->getNomAdministrador()) ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="Apellidos" value="<?php echo($administrador->getApellidoAdministrador()) ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="email" class="form-control" id="correo" value="<?php echo($administrador->getCorreoAdministrador()) ?>" readonly>
                                    </div>
        ...
        function EditarPerfil(){
            datos = $('#formEditar').serialize();
                    ...
                    $.ajax({
                        type: "POST",
                        data: datos,
                        url: "./EditarPerfilAdministrador.php",
                        success: function(r) {
                            ...
                            if (r == 0) {
                                ...
                                location.href="/ProyectoFeria/AppFeria/Admin/index.php"
