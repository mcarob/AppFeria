...
if (isset($_GET["action"])) {
    ...
    $listaVacantes = $conPromocion->verOfertas3($var,0,8);
    $total=$conPromocion->cantidadOfertas3($var);
}
else{
...
if (isset($_GET["pagina"])){
    $conPromocion = new ControladorPromocion();
    $listaVacantes = $conPromocion->verOfertas3($var,($_GET["pagina"]-1)*8,8);
    $total=$conPromocion->cantidadOfertas3($var);
    $pagina=$_GET["pagina"];
}
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item"><a class="page-link"
                                <?php echo('href="ofertasTabla.php?action='.$_GET["action"].'&pagina='.(1).'"'); ?>><?php echo (1);  ?></a>
                        </li>
                        <?php   
                            }elseif ($total<=16){
                            ?>
                        ...
                        <li class="page-item"><a class="page-link"
                                <?php echo('href="ofertasTabla.php?action='.$_GET["action"].'&pagina='.(2).'"'); ?>><?php echo (2);  ?></a>
                        </li>
                        <?php   
                            }elseif($total<=24){
                            ?>
                        ...
                        <li class="page-item"><a class="page-link"
                                <?php echo('href="ofertasTabla.php?action='.$_GET["action"].'&pagina='.(3).'"'); ?>><?php echo (3);  ?></a>
                        </li>
                        <?php   
                            }else{
                                if($pagina>1){
                        ...
                        <li class="page-item">
                            <a class="page-link"
                                <?php echo('href="ofertasTabla.php?action='.$_GET["action"].'&pagina='.($pagina-1).'"'); ?>
                        ...
                        <?php
                                    ...
                                    ?>
                        <!--  href="ofertasTabla.php?action?v&pagina=v" -->
                        <li class="page-item"><a class="page-link"
                                <?php echo('href="ofertasTabla.php?action='.$_GET["action"].'&pagina='.($pagina-2).'"'); ?>><?php echo ($pagina-2);  ?></a>
                        </li>
                        <li class="page-item"><a class="page-link"
                                <?php echo('href="ofertasTabla.php?action='.$_GET["action"].'&pagina='.($pagina-1).'"'); ?>><?php echo ($pagina-1);  ?></a>
                        </li>
                        <li class="page-item"><a class="page-link"
                                <?php echo('href="ofertasTabla.php?action='.$_GET["action"].'&pagina='.($pagina).'"'); ?>><?php echo ($pagina);  ?></a>
                        </li>
                        <?php
                                }else{
                                    ?>
