...
$(document).ready(function() {
    ...
    $('#addf2').click(function() {
        ...
        $('#agregarf2').append('<div id="row2' + j +
            ...
            '[]" aria-label="Username"> </div> </div> <div class="col-md-6 mb-3"> <h5>Cantidad de horas</h5> <br> <div class="input-group"> <div class="input-group-prepend"> <span class="input-group-text"> <i class="material-icons">face</i> </span> </div> <input type="text" class="form-control" placeholder="Horas" aria-label="Username" id="complementaria' +
            j + '[]" required name="complementaria' + j +
