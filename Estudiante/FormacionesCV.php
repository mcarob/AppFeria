...
<h3>Perfil:</h3>
<button  type="button" class="btn mb-1 btn-warning btn-pill" data-container="body" data-toggle="popover" data-placement="right" data-content="Recuerde que en el perfil debe añair informacion como, idiomas, hobbies, caracteristicas personales.">
    ?
</button>   
<br>
    ...
    $(document).ready(function() {
        ...
        $('#addf2').click(function() {
            ...
            $('#agregarf2').append('<div id="row2' + j +
                ...
                j + '[]" required name="complementaria' + j +
                '[]"> </div> </div> </div> </div><button type="button" name="remove" id="' +
